...
public class Player : MonoBehaviour
{
    ...
    //Jump stuff! This is (mostly) the same as 2D
    ...
    void Movement()
    {
        ...
        {
            //KINEMATICSSSSSSSSSSSSSSS
            //v^2 = u^2 + 2(as)
            //Final velocity = velocity squared + 2 * (acceleration *
            //vector displacement [how far, and in what direction an object 
            //is moving])
            //0 = u^2 + 2 * a * s
            //u^2 = -2 * a * s
            //Therefore, u = square root(-2) * acceleration * displacement
            velocity.y = Mathf.Sqrt(jumpHeight * -2f * Physics.gravity.y);

            //MAYBE - reset isGrounded here.
        }
